        ...
        <div class="welcome-banner">
            <div class="banner-content">
                ...
                <div class="illustration">
                    <img :src="welcomeImg" alt="working"/>
                </div>
            </div>
        </div>
                    ...
                    <div class="tools-grid">
                        ...
                        >
                            <div class="icon-wrapper" :style="{ background: tool.bgColor }">
                                <el-icon :color="tool.color" :size="24">
...
// 3. 执行主题切换逻辑
const executeToggleTheme = () => {
    toggleDark();

    // 可选：增加视觉反馈
    const mode = isDark.value ? '暗黑' : '明亮';
    ElMessage({
        message: `已成功切换至 ${mode} 模式`,
        type: 'success',
        duration: 1500,
        showClose: true
    });
...
const updateTime = () => {
    ...
    timeState.weekStr = days[now.getDay()] as string;
    // 时间 HH:mm
...
//
//    .welcome-banner {
//        // 使用渐变色时，可以根据 html.dark 类名调整
//        background: linear-gradient(120deg, #a1c4fd 0%, #c2e9fb 100%);
//
//        // 当处于暗黑模式时，调低 Banner 的亮度或改变色调
//        :deep(html.dark) & {
//            background: linear-gradient(120deg, #1d2b4a 0%, #1a3c4d 100%);
//        }
//    }
//
//    // 快捷入口卡片在暗黑模式下的背景调整
//    .tool-item:hover {
//        background: var(--el-fill-color-light); // 使用 ElementPlus 内置变量
//    }
//
//    // 时钟卡片适配
//    .clock-card {
//        // 之前是硬编码的 #2c3e50，在暗黑模式下可能需要深一点或浅一点
