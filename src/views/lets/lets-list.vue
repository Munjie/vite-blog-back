<template>
    <div>
        ...
        <div class="container">
            ...
            >
                <template #toolbarBtn>
                    <el-button type="warning" :icon="CirclePlusFilled" @click="handleAdd">申请证书</el-button>
                </template>
            </CustomTable>
        </div>
    </div>
...
import {deleteDomain, pageLets} from "../../api/lets.ts";
...
const fetchList = async () => {
    try {
        ...
        const res = await pageLets(taskForm);
