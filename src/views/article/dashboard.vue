                    ...
                    <div class="comment-list">
                        ...
                        <div v-for="item in comments" :key="item.id" class="comment-item">
                            ...
                            <div class="comment-content">
                                ...
                                <div class="comment-text text-truncate">
                                    {{ item.content }}
                                </div>
                            </div>
                        </div>
...
import {getVisitMap, getVisitCount, getVisitLine, getComments} from "../../api/home.ts";
...
const initLine = async () => {
    ...
    // const {data: res} = await getVisitLine()
    const { data: res } = (await getVisitLine()) as any;
    const {dates, pvs, uvs} = res;
    lineChart.setOption({
